...
// AdminApproval provides a mock function with given fields:
func (_m *UserHandler) AdminApproval() echo.HandlerFunc {
	ret := _m.Called()
...
// ListUserRequest provides a mock function with given fields:
func (_m *UserHandler) ListUserRequest() echo.HandlerFunc {
	ret := _m.Called()
...
func (_m *UserHandler) SearchUser() echo.HandlerFunc {
	ret := _m.Called()
...
// ShowAnotherUserByID provides a mock function with given fields:
func (_m *UserHandler) ShowAnotherUserByID() echo.HandlerFunc {
	ret := _m.Called()
...
func (_m *UserHandler) UpdatePassword() echo.HandlerFunc {
	ret := _m.Called()
