...
import (
	...
	models "alta-cookit-be/features/ingredients/models"
)
...
func (_m *IngredientData_) DeleteIngredientByRecipeId(ingredientEntity *ingredients.IngredientEntity) error {
	ret := _m.Called(ingredientEntity)
...
// SelectIngredientById provides a mock function with given fields: id
func (_m *IngredientData_) SelectIngredientById(id uint) *models.Ingredient {
	ret := _m.Called(id)

	var r0 *models.Ingredient
	if rf, ok := ret.Get(0).(func(uint) *models.Ingredient); ok {
		r0 = rf(id)
	} else {
		if ret.Get(0) != nil {
