...
const (
	ECHO_P_FollowerId          = "follower_id"
	ECHO_P_RecipeId            = "recipe_id"
	ECHO_P_LikeId              = "like_id"
	ECHO_P_CommentId           = "comment_id"
	...
	ECHO_P_TransactionDetailId = "transaction_detail_id"
)
...
const (
	...
	ECHO_ErrorBindData        string = "error bind data"
	ECHO_InvalidImageFileType string = "invalid image file type"
	ECHO_InvalidFileSize      string = "invalid file size"
)
